...
namespace EfCorePaging.SharedServer.Services
{
    ...
    {
        private readonly IDbContextFactory<SomeTacoContext> _contextFactory;

        public TacoService(IDbContextFactory<SomeTacoContext> contextFactory)
        {
        ...
        public async Task<ToppingInfo> GetToppings(PagerInfo pagerInfo, CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                var toppingQuery = context.Toppings.AsNoTracking();
